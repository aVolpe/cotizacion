  ...
  <v-app id="inspire">
    <v-navigation-drawer v-model="drawer" location="right" app>
      <v-list density="compact">
        <v-list-item v-for="route in routes" :key="route.to" :to="route.to">
    ...
    <v-app-bar color="primary" density="default" app>
      <v-spacer></v-spacer>
      <v-app-bar-title @click="goHome()" class="title" style="text-align: center">
        Cotizaciones
      </v-app-bar-title>
      <v-spacer></v-spacer>
    ...
    <v-main>
      <v-container fluid class="main-container">
        <v-row justify="center" align="center">
          <v-col cols="12" md="7" class="text-center mt-1">
            <router-view />
          </v-col>
        </v-row>
      </v-container>
